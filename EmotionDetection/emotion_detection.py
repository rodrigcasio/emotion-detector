...
def emotion_detector(text_to_analyze):
    """
    This function generates a post request to obtain response from the WATSON NLP API.
    Error handling is included for failure to NLP responses. Finally, it parses the json raw response
    to a python dictionary and proides specific key-value pairs extracted from the response, returning
    to the server the formatted emotion scores and calculated emotion with maximum score.
    """
...
--------------------------------------------------------------
(Raw JSON response view from Watson NLP)
